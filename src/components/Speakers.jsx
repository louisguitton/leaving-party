...
import miroImage from '@/images/avatars/miro.jpg'
...
const days = [
  {
    ...
    speakers: [
      {
        name: 'Pierre',
        role: 'I like folding T-shirts and proteines',
        image: ronniCantadoreImage,
      },
      {
        name: 'Marie',
        role: 'I refused Sisyphos to come tonight',
